"""FastAPI server application for the Oil & Gas Rig Navigator Agent.
...
app.title = "Oil & Gas Rig Navigator Agent"
app.description = "API for interacting with the Oil & Gas Rig Navigator Agent"
